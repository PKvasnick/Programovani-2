...
V předchozí ukázce je ale přesný opak situace, kdy chceme vyznačit typy argumentů a návratové hodnoty. To, co potřebujeme říct je, že argumenty pro sečítání musí být stejného typu a stejného typu bude i návratová hodnota funkce. Úzké vymezení typu nám naopak způsobí problém: museli bychom pro každý typ argumentu napsat speciální funkci.
