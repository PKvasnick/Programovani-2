...
2. **Domácí úkoly** Poslední úloha na spojované seznamy (destruktívní průnik) a jednoduchá úloha se závorkami
3. **Zápočtový program**: Jsme v půlce dubna a zatím mám jediný návrh na zápočtový program. Prosím, neodkládejte to a pokud si neumíte poradit, ozvěte se.
...
- Rekurze: sudoku
- Binární stromy: průchod
- Binární stromy: stromy výrazů
...
- Používejte docstringy a doctesty u funkcí a tříd.
...
### 1. Destruktivní průnik

U této úlohy platí to, co jsme si doteď říkali o protivně komplexním kódu: Vyžeňte komplexitu do jasně definovaných funkcí, abyste se mohli soustředit na podstatu problému.

**Sláva a pád rekurze**

Rekurzivní řešení problému je elegantní a nepříliš užitečné, jak už rekurzivní řešení bývají:
...
Toto byla lehká úloha a tento problém jste už řešili. Nevýhodou lehkých úloh je, že se očekává, že všichni je lehce vyřeší. 
...
Každý uzel má nejvíc dvě větve a pokud neřekneme jinak, pracujeme s kompletními stromy, tedy chybí jen několik uzlů v poslední vrstvě.
...
Rekurzivní procházení stromem do hloubky (depth-first)
...
**Procházení s O(1) dodatečnou pamětí**

Pokud by každý uzel věděl, kdo je jeho předchůdce, nepotřebovali bychom pro procházení stromu ani zásobník, tedy bychom nemuseli vytvářet kopii všech dat stromu. 
